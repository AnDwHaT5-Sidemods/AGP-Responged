    ...
    public CommandResult execute(CommandSource sender, CommandContext args) {
        ...
        for (String anArgList : argList) {
            ...
            if (anArgList.toLowerCase().startsWith("rules:") && !anArgList.toLowerCase().equalsIgnoreCase("rules:")) {
                ...
                if (anArgList.toLowerCase().startsWith("require:") && !anArgList.toLowerCase().equalsIgnoreCase("require:")) {
                    ...
                    if (anArgList.toLowerCase().startsWith("level:") && !anArgList.toLowerCase().equalsIgnoreCase("level:")) {
                        ...
                        if (anArgList.toLowerCase().startsWith("money:") && !anArgList.toLowerCase().equalsIgnoreCase("money:")) {
                            ...
                            if (anArgList.toLowerCase().startsWith("name:") && !anArgList.toLowerCase().equalsIgnoreCase("name:")) {
                                ...
                                if (anArgList.toLowerCase().startsWith("badge:") && !anArgList.toLowerCase().equalsIgnoreCase("badge:")) {
